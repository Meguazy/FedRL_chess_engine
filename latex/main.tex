...
\usepackage[english]{babel}  % CHANGED: italian -> english
...
%%%	PATH for images
\graphicspath{{./images/}}  % CHANGED: ./immagini/ -> ./images/
...
\theoremstyle{plain}
% CHANGED: All theorem environments translated to English
...
% Acknowledgements  % CHANGED: Ringraziamenti -> Acknowledgements
\end{document}
